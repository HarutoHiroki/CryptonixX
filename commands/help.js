...
exports.run = (client, message, args) => {
  if(!args[0]){
      if (message.author.id === settings.ownerid) {  
        ...
        .addField("All commands have been migrated to here: (mobile not supported, yet.)", "https://harutohiroki.github.io/cryptonix/commands.html")
        ...
        .addField("All commands have been migrated to here:", "https://harutohiroki.github.io/cryptonix/commands.html")
        .addField("For more info about a specific Command:", "Use [prefix]help command_name")
        .setFooter(`© Cryptonix X Mod Bot by ${customisation.ownername}`);
        message.author.send({embed}).catch(e =>{
          if (e) {
